    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center">
          ...
          />
          <h1 className="text-2xl font-bold text-white">{import.meta.env.VITE_APP_TITLE || 'FirePCR'}</h1>
          <p className="text-gray-400 text-sm mt-1">{import.meta.env.VITE_COMPANY_DBA || 'Ridgeline EMS'}</p>
        </div>
